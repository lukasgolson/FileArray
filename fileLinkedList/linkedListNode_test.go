...
func TestNodeSerializeDeserialize(t *testing.T) {
	node1 := linkedListNode[util.Number]{NextOffset: 43, Item: *new(util.Number)}
	...
	var node2 linkedListNode[util.Number]
...
func TestEdgeSerializedSize(t *testing.T) {
	node := linkedListNode[util.Number]{NextOffset: 43, Item: *new(util.Number)}
